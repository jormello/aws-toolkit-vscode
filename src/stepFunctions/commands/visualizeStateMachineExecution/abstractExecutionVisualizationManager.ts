...
export abstract class AbstractExecutionVisualizationManager<T extends ExecutionVisualization = ExecutionVisualization> {
    ...
    public abstract visualizeStateMachineExecution(
