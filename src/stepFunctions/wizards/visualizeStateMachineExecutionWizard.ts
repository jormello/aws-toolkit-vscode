...
export enum VisualizeStateMachineExecutionAction {
    QuickCreate,
    QuickUpdate,
}
...
function createPublishActionPrompter(region: string): QuickPickPrompter<VisualizeStateMachineExecutionAction> {
    const publishItems: DataQuickPickItem<VisualizeStateMachineExecutionAction>[] = [
        {
            ...
            data: VisualizeStateMachineExecutionAction.QuickCreate,
        },
        {
            ...
            data: VisualizeStateMachineExecutionAction.QuickUpdate,
        },
    ]
...
export interface VisualizeStateMachineExecutionWizardState {
    readonly region: string
    readonly publishAction: VisualizeStateMachineExecutionAction
...
export class VisualizeStateMachineExecutionWizard extends Wizard<VisualizeStateMachineExecutionWizardState> {
    public constructor(region?: string) {
        ...
        //     {
        //         showWhen: form => form.publishAction === VisualizeStateMachineExecutionAction.QuickCreate,
        //     }
        // )
        ...
        //     showWhen: form => form.publishAction === VisualizeStateMachineExecutionAction.QuickUpdate,
        // })
    }
}
